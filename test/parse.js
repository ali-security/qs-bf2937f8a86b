...
test('mixed notation exceeding arrayLimit is consistent and lossless (ljharb/qs#546)', function (t) {
    t.deepEqual(
        qs.parse('a[]=b&a[1]=c&a=d', { arrayLimit: 0 }),
        { a: { 0: 'b', 1: 'c', 2: 'd' } },
        'arrayLimit 0: no value dropped'
    );
    t.deepEqual(
        qs.parse('a[]=b&a[1]=c&a=d', { arrayLimit: -1 }),
        { a: { 0: 'b', 1: 'c', 2: 'd' } },
        'arrayLimit -1: no value dropped'
    );
